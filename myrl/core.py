...
# import custom defined library, changes are made to the fit function
from myrl.callbacks import NewTrainEpisodeLogger
...
class Agent(object):
    ...
    def fit(self, env, nb_steps, action_repetition=1, callbacks=None, verbose=1,
        ...
        if verbose == 1:
            ...
            callbacks += [NewTrainEpisodeLogger()]
        if visualize:
