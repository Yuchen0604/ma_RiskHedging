...
HOURLY_COST = 1
# reward_episode file
FILE1 = "E:/training/weeklyR2/reward_10400epi.txt"
# result file
FILE2 = "E:/training/weeklyR2/record/record_ep_{}.csv"

class weeklyR2Env(gym.Env):
    ...
    def step(self, action):
        ...
        self.price = self.df.loc[self.current_index, 'yes_price']
        self._take_action(action)
        self.hourly_income = self.e_sell * self.price
        self.reward = self.hourly_income - HOURLY_COST
    ...
    def render(self, mode='human', ):
        ...
        value1 = {
                 ...
                 "hourly income": self.hourly_income,
