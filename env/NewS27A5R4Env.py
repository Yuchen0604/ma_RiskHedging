...
HOURLY_COST = 1
# reward_episode file
FILE1 = "E:/training/weeklyR4/run2/results.txt"
# result file
FILE2 = "E:/training/weeklyR4/run2/record/record_ep_{}.csv"

class R4Run2Env(gym.Env):
    def __init__(self, data):
        ...
        self.observation_space = spaces.Box(low=-high, high=high, shape=(27,), dtype=np.float32)

    def _next_observation(self):
        # forecasted generation, available upward energy and downward energy of hour t
        ...
        obs_yp = yp.reshape(24, )
        # whole observation
        obs = np.concatenate((obs_t, obs_yp))
